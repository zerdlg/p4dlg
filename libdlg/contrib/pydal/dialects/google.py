import libdlg.dlgQuery_and_operators
...
class GoogleDatastoreDialect(NoSQLDialect):
    FILTER_OPTIONS = {
        ...
        '>=': lambda a, b: a >= b,
        '!=': lambda a, b: a != b,
        'in': lambda a, b: libdlg.supOperators.IN(b)
    }
    ...
    def _and(self, first, second, query_env={}):
        ...
        if first == None:
            return second
        return libdlg.supOperators.AND(first, second)
    ...
    def _or(self, first, second, query_env={}):
        ...
        if first == None or second == None:
            return None
        return libdlg.supOperators.OR(first, second)
