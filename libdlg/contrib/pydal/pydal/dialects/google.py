import libdlg.dlgOperators
import libsql.sqlQuery
...
class GoogleDatastoreDialect(NoSQLDialect):
    FILTER_OPTIONS = {
        ...
        ">=": lambda a, b: a >= b,
        "!=": lambda a, b: a != b,
        "in": lambda a, b: libsql.dlgQuery.IN(b),
    }
    ...
    def _and(self, first, second, query_env={}):
        ...
        if first == None:
            return second
        return libdlg.dlgQuery_and_operators.AND(first, second)
    ...
    def _or(self, first, second, query_env={}):
        ...
        if first == None or second == None:
            return None
        return libdlg.dlgQuery_and_operators.OR(first, second)
